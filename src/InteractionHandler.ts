import { BaseInteraction, ChatInputCommandInteraction, Collection, ContextMenuCommandInteraction } from "discord.js";
...
export interface InteractionHandler<I extends BaseInteraction> {
    ...
    execute: (interaction: I, commands: Collection<string, CommandBase<any>>, context: any) => Promise<void>;
}

export const chatInputCommandInteractionHandler: InteractionHandler<ChatInputCommandInteraction> = {
    typeGuard: (interaction): interaction is ChatInputCommandInteraction => interaction.isChatInputCommand(),
...
export const contextMenuCommandInteractionHandler : InteractionHandler<ContextMenuCommandInteraction> = {
    typeGuard: (interaction): interaction is ContextMenuCommandInteraction => interaction.isContextMenuCommand(),
    check: (interaction) => true,
    execute: async (interaction, commands, context) => {
